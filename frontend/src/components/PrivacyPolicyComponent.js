...
export default class PrivacyPolicyComponent extends Component {
	render() {
		return (
			<div class="body-b">
				<h1>Privacy Policy for KYN</h1>

				<p>
					At Know Your Neighbourhood, accessible from www.kyn.com, one of our
					main priorities is the privacy of our visitors. This Privacy Policy
					document contains types of information that is collected and recorded
					by Know Your Neighbourhood and how we use it.
				</p>
				...
				<p>
					...
					shared and/or collect in Know Your Neighbourhood. This policy is not
				...
				<p>
					Know Your Neighbourhood follows a standard procedure of using log
				...
				<p>
					Like any other website, Know Your Neighbourhood uses 'cookies'. These
